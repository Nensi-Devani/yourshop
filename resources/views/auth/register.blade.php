        ...
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 border shadow p-3" style="border-radius: 20px;width:27rem">
                <h2 class="text-center text-dark-blue">Register</h2>
                ...
                <div class="form-outline mb-3">
                    ...
                    <input id="email" type="email" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Enter valid email address">
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  ...
                  <p class="small fw-bold mt-3 pt-1 mb-0">Already have an account? <a wire:navigate href="{{url('login')}}"
