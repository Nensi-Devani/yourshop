<div class="row">
    @section('title')
        Viewing Sizes
    @endsection
    @include('livewire.admin.size.modal-form')
    {{-- pre loader --}}
    <div wire:loading>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mt-1">Sizes
                        <a wire:click="showModal('add')" class="btn btn-primary rounded text-white float-end" data-bs-toggle="modal" data-bs-target="#addBrandModal">Add Size</a>
                    </h3>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                                @forelse ($sizes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a wire:click="deleteSize({{$item->id}})" class="text-white btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deletemodal">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-danger">No Sizes Found !!!</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
