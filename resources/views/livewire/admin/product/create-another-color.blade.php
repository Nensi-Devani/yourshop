        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="mt-1">Add Product Color
                        ...
                        <div class="tab-content border border-1 px-2" id="myTabContent">
                            <div class="tab-pane fade show active" id="home-tab-plane" role="tabpanel" wire:ignore.self>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="text" wire:model="category" class="form-control" readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 mt-3">
                                            <label for="">Category <span class="text-danger">*</span></label>
                                            <input type="text" wire:model="subcategory" class="form-control" readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    {{-- <small class="text-danger">{{$slug_err}}</small> --}}
                                </div>
                                <div class="row">
                                    <div class="{{$material!=null?'col-md-6':'col-md-12'}}">
                                        <div class="mb-3 mt-3">
                                            <label for="">Brand <span class="text-danger">*</span></label>
                                            <input type="text" wire:model="brand" class="form-control" readonly>
                                    ...
                                    @if ($material)
                                        <div class="col-md-6">
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input type="text" wire:model="material" class="form-control" readonly>
                            ...
                            <div class="tab-pane fade show" id="details-tab-plane" role="tabpanel" wire:ignore.self>
                                        ...
                                        <div class="m-0 p-0 d-flex">
                                            <div class="col-6 m-0 p-0 d-flex  align-items-center justify-content-center">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input wire:model="trending" class="form-check-input form-control mx-md-3 mx-1" type="checkbox" {{$trending==1?'checked':''}}>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6 m-0 p-0 d-flex  align-items-center justify-content-center">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input wire:model="status" class="form-check-input form-control mx-3" type="checkbox" {{$status==1?'checked':''}}>
                                                </div>
                                            </div>
                                ...
                                <div class="row mt-2">
                                    @if ($showSize == "no-size")
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="1" wire:model="delivaryCharge" value="{{old('quantity')}}" class="form-control mt-1">
                                    ...
                                    @else
                                                            ...
                                                            <div class="card rounded shadow-sm p-3" style="width: 18rem;">
                                                                <div class="">
                                                                    ...
                                                                    <div class="d-flex mb-2 align-items-center justify-content-between">
                                                                        ...
                                                                        <input type="number" min="1" wire:model="sizeQty.{{$item->id}}" class="form-control form-control-sm mt-1 w-75">
                                                                    </div>
                                                                    <div class="d-flex mb-2 align-items-center justify-content-between">
                                                                        <label for="">Ori. Price</label>
                                                                        <input type="number" min="1" wire:model="sizeOriginalPrice.{{$item->id}}" class="form-control form-control-sm mt-1 w-75">
                                                                    </div>
                                                                    <div class="d-flex mb-2 align-items-center justify-content-between">
                                                                        <label for="">Price <span class="text-danger">*</span></label>
                                                                        <input type="number" min="1" wire:model="sizePrice.{{$item->id}}" class="form-control form-control-sm mt-1 w-75">
                                                                    </div>
                                                                    <div class="d-flex mb-2 align-items-center justify-content-between">
                                                                        <label for="">Delivery </label>
                                                                        <input type="number" min="1" wire:model="sizeDeliveryCharge.{{$item->id}}" class="form-control form-control-sm mt-1 w-75">
                                                                    </div>
                                        ...
                                        @else
                                            <p class="text-danger mx-3">Sizes not awailable !!!</p>
                                        @endif
                                    @endif
                                </div>
                            </div>
                            ...
                            <div>
                                <button type="submit" class="btn bg-blue text-light float-end mt-2 mx-2">Submit</button>
                                <button type="button" wire:click='addAnotherColor' value="done" class="btn btn-primary text-light float-end mt-2">Save & Add another color</button>
                            </div>
                        </div>
                    </form>
                </div>
