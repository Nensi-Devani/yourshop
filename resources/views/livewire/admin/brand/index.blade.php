        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mt-1">Brands
                        <a wire:click="addModal" class="btn btn-primary rounded text-white float-end" data-bs-toggle="modal" data-bs-target="#addBrandModal">Add Brand</a>
                    </h3>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                                @forelse ($brands as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a wire:click="deleteBrand({{$item->id}})" class="text-white btn btn-sm btn-danger text-light" data-bs-toggle="modal" data-bs-target="#deletemodal">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-danger">No Brands Found !!!</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
